...
/*
Problems:
- Sometimes threads don't exit properly because they never reach the barrier in the section, since there are only two sections and typically at least 4 threads. Fixed by removing barrier in print_results
