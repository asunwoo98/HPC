...
/*
Problems:
- statically allocated arrays cannot be a shared variable. Fixed by dynamically allocating.
- Deadlock caused by use of the two locks. Fixed by altering the order in which the lock is released in the first section.
*/
#include <omp.h>
#include <stdio.h>
#include <stdlib.h>
